...
Las llaves parciales tienen como sintaxis:
...
Esta es quizá la sintaxis más compleja, primero debemos establecer el nombre del atributo y después el nombre de quienes se componen
	"nombre_tipo_entidad",otro,{llave_primaria},C(|nombre_compuesto|:elemento;que;lo;componen)
